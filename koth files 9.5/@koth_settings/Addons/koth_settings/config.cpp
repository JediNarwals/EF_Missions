...
class CfgPatches {
    class CfgKingOfTheHillSettingsPatch {
    units[] = {};
    weapons[] = {};
    requiredVersion = 0.1;
    requiredAddons[] = {};
...
class CfgKingOfTheHillSettings {

    teamBalanceEnabled = 1;
    teamBalanceThreshold = 4;
    teamBalanceMinSidePlayers = 10;
    teamBalanceStartsAfterTime = 300;
    noSameTown = 1;
    shutdownServerAfterRounds = 0;
    noSameTime = 0;
    shutdownServerPassword = "armaisthebest";
    disableVehicleThermals = 1;
    ...
    class RulesDialog {
        class RulesText {
            English = "Speaking in Global Voice Chat is not allowed. <br/> \
Playing music or sounds ingame is not allowed <br/> \
Teamkilling and Teamstacking are not allowed. <br/> \
Do not spam or offend others. <br/> \
Kamikaze is not allowed. <br/> \
The main access road must not be used. <br/> \
Hacking, scripts or cheating is not allowed. <br/> \
";
        };
    };
    ...
    DisabledWeapons[] = {"srifle_DMR_05_tan_f"};
