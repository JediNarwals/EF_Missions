...
*/
kgjjhs={if(kgkyng||kg4bsk||!isNil{if(isNull(uiNamespace getVariable "KingOfHill_PlayerMenu"))then{nil}else{true}})exitWith{};kgymt4=true;createDialog "KingOfHill_PlayerMenu";};kgz6cz={disableSerialization;private["_0a"];_0a=_this;[_0a,""]call bis_fnc_guiEffectTiles;call kgzweq;true spawn kgcm3e;};kgp6xc={};kgzweq={disableSerialization;private["_0a","_0p"];_0a=uiNamespace getVariable "KingOfHill_PlayerMenu";_0p=_0a displayCtrl kg2lwm;_0p ctrlSetStructuredText parseText format["Money earned: <t color='#aaffaa'>%1 $</t><br/>Total experience: <t color='#%3'>%2 xp</t><br/>Total play time: %4",kgeu96 call kgkzn8,kg8jf4 call kgkzn8,kgvsvh,kgv82e call kgug1l];};kgcm3e={disableSerialization;private["_0a","_0p"];_0a=uiNamespace getVariable "KingOfHill_PlayerMenu";_0p=_0a displayCtrl kg51dn;waitUntil{_0p ctrlSetText format["Saved %1 ago",(diag_tickTime-kga4bj)call kgug1l];call kgzweq;sleep 0.3;isNull(_0a)};};kgcj65={if((diag_tickTime-kga4bj)<3)exitWith{};call kgttgb;};